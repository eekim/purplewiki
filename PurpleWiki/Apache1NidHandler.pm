# PurpleWiki::Apache1NidHandler.pm
# vi:ai:sw=4:ts=4:et:sm
#
# $Id: Apache1NidHandler.pm,v 1.1.2.3 2004/02/07 04:12:26 cdent Exp $
#
...
sub handler {
    ...
    my $purpleConfig = new PurpleWiki::Config($r->dir_config('PurpleConfig'));
